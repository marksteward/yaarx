...
.PHONY: va-tests
va-tests: $(BIN_PATH)va-tests

$(BIN_PATH)va-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)bsdr.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)va-tests.o
...
.PHONY: adp-rot-tests
adp-rot-tests: $(BIN_PATH)adp-rot-tests

$(BIN_PATH)adp-rot-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-rot.o $(OBJ_PATH)adp-rot-tests.o
...
.PHONY: adp-rot-program
adp-rot-program: $(BIN_PATH)adp-rot-program

$(BIN_PATH)adp-rot-program: $(OBJ_PATH)common.o $(OBJ_PATH)adp-rot.o $(OBJ_PATH)adp-rot-program.o
...
.PHONY: adp-mul-tests
adp-mul-tests: $(BIN_PATH)adp-mul-tests

$(BIN_PATH)adp-mul-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-mul.o $(OBJ_PATH)adp-mul-tests.o
	$(CC) $(LFLAGS) $(ADP_MUL_TESTS_OBJ) -o $(BIN_PATH)adp-mul-tests $(LIBS)

$(OBJ_PATH)adp-mul-tests.o: 
...
$(BIN_PATH)idea: $(OBJ_PATH)common.o $(OBJ_PATH)bsdr.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-xor-count-odiff.o $(OBJ_PATH)adp-xor-fi.o $(OBJ_PATH)adp-xor-fi-count-odiff.o $(OBJ_PATH)adp-mul.o $(OBJ_PATH)idea.o
...
.PHONY: simon
simon: $(BIN_PATH)simon

$(BIN_PATH)simon: $(OBJ_PATH)common.o $(OBJ_PATH)simon.o
...
.PHONY: speck
speck: $(BIN_PATH)speck

$(BIN_PATH)speck: $(OBJ_PATH)common.o $(OBJ_PATH)speck.o
...
.PHONY: xdp-and-tests
xdp-and-tests: $(BIN_PATH)xdp-and-tests

$(BIN_PATH)xdp-and-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-and.o $(OBJ_PATH)xdp-and-tests.o
...
xdp-rot-and-tests: $(BIN_PATH)xdp-rot-and-tests

$(BIN_PATH)xdp-rot-and-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-and.o $(OBJ_PATH)xdp-rot-and.o $(OBJ_PATH)xdp-rot-and-tests.o
...
$(BIN_PATH)simon-xor-threshold-search-tests: $(OBJ_PATH)common.o $(OBJ_PATH)simon.o $(OBJ_PATH)xdp-and.o $(OBJ_PATH)xdp-rot-and.o $(OBJ_PATH)simon-xor-ddt-search.o $(OBJ_PATH)simon-xor-threshold-search.o $(OBJ_PATH)simon-xor-threshold-search-tests.o
...
.PHONY: speck-xor-threshold-search-tests
speck-xor-threshold-search-tests: $(BIN_PATH)speck-xor-threshold-search-tests

$(BIN_PATH)speck-xor-threshold-search-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)xdp-add-pddt.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)speck.o $(OBJ_PATH)speck-xor-ddt-search.o $(OBJ_PATH)speck-xor-threshold-search.o $(OBJ_PATH)speck-xor-threshold-search-tests.o
...
.PHONY: speck-best-diff-search-tests
speck-best-diff-search-tests: $(BIN_PATH)speck-best-diff-search-tests

$(BIN_PATH)speck-best-diff-search-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)speck.o $(OBJ_PATH)speck-xor-threshold-search.o $(OBJ_PATH)speck-best-diff-search-tests.o
...
.PHONY: speck-best-linear-search-tests
speck-best-linear-search-tests: $(BIN_PATH)speck-best-linear-search-tests

$(BIN_PATH)speck-best-linear-search-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xlp-add.o $(OBJ_PATH)speck.o $(OBJ_PATH)speck-best-linear-search-tests.o
...
.PHONY: xdp-add-diff-set-tests
xdp-add-diff-set-tests: $(BIN_PATH)xdp-add-diff-set-tests

$(BIN_PATH)xdp-add-diff-set-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)xdp-add-diff-set-tests.o
...
.PHONY: tweetcipher-tests
tweetcipher-tests: $(BIN_PATH)tweetcipher-tests

$(BIN_PATH)tweetcipher-tests: $(OBJ_PATH)common.o $(OBJ_PATH)tweetcipher-tests.o
	$(CC) $(LFLAGS) $(TWEETCIPHER_TESTS_OBJ) -o $(BIN_PATH)tweetcipher-tests $(LIBS)

$(OBJ_PATH)tweetcipher-tests.o: 
...
.PHONY: threefish-tests
threefish-tests: $(BIN_PATH)threefish-tests

$(BIN_PATH)threefish-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)threefish.o $(OBJ_PATH)threefish-xor.o $(OBJ_PATH)threefish-add.o $(OBJ_PATH)threefish-tests.o
	$(CC) $(LFLAGS) $(THREEFISH_TESTS_OBJ) -o $(BIN_PATH)threefish-tests $(LIBS)

$(OBJ_PATH)threefish-tests.o: 
	$(CC) $(CFLAGS) -I$(INCLUDES) $(TESTS_PATH)threefish-tests.cc -o $(OBJ_PATH)threefish-tests.o

$(OBJ_PATH)threefish.o: 
	$(CC) $(CFLAGS) -I$(INCLUDES) $(SOURCE_PATH)threefish.cc -o $(OBJ_PATH)threefish.o

$(OBJ_PATH)threefish-xor.o: 
	$(CC) $(CFLAGS) -I$(INCLUDES) $(SOURCE_PATH)threefish-xor.cc -o $(OBJ_PATH)threefish-xor.o

$(OBJ_PATH)threefish-add.o: 
...
.PHONY: salsa-tests
salsa-tests: $(BIN_PATH)salsa-tests

$(BIN_PATH)salsa-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)salsa.o $(OBJ_PATH)salsa-tests.o
	$(CC) $(LFLAGS) $(SALSA_TESTS_OBJ) -o $(BIN_PATH)salsa-tests $(LIBS)

$(OBJ_PATH)salsa-tests.o: 
...
.PHONY: rc5-tests
rc5-tests: $(BIN_PATH)rc5-tests

ifdef COMPILE_WITH_CODING_TOOL_LIB
$(BIN_PATH)rc5-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)max-adp-xor.o $(OBJ_PATH)adp-rot.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)xdp-add-diff-set.o $(OBJ_PATH)rc5-ref.o $(OBJ_PATH)rc5-lwcs.o $(OBJ_PATH)rc5-dc.o $(OBJ_PATH)rc5-eq.o $(OBJ_PATH)rc5-alex.o $(OBJ_PATH)add-approx.o $(OBJ_PATH)rc5-blind-oracle.o $(OBJ_PATH)rc5-tests.o
...
.PHONY: xtea-xor-threshold-search
xtea-xor-threshold-search: $(BIN_PATH)xtea-xor-threshold-search

$(BIN_PATH)xtea-xor-threshold-search: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)xtea.o $(OBJ_PATH)xdp-xtea-f-fk.o $(OBJ_PATH)xtea-f-xor-pddt.o $(OBJ_PATH)xtea-xor-threshold-search.o $(OBJ_PATH)xtea-xor-threshold-search-tests.o
...
.PHONY: xtea-add-threshold-search
xtea-add-threshold-search: $(BIN_PATH)xtea-add-threshold-search
...
.PHONY: adp-xtea-f-fk-tests
adp-xtea-f-fk-tests: $(BIN_PATH)adp-xtea-f-fk-tests
...
.PHONY: xdp-xtea-f-fk-tests
xdp-xtea-f-fk-tests: $(BIN_PATH)xdp-xtea-f-fk-tests
...
.PHONY: xdp-tea-f-fk-tests
xdp-tea-f-fk-tests: $(BIN_PATH)xdp-tea-f-fk-tests
...
.PHONY: tea-add-threshold-search
tea-add-threshold-search: $(BIN_PATH)tea-add-threshold-search
...
.PHONY: tea-f-add-pddt-tests
tea-f-add-pddt-tests: $(BIN_PATH)tea-f-add-pddt-tests

$(BIN_PATH)tea-f-add-pddt-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-set.o $(OBJ_PATH)tea.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)eadp-tea-f.o $(OBJ_PATH)adp-tea-f-fk.o $(OBJ_PATH)tea-f-add-pddt.o $(OBJ_PATH)tea-f-add-pddt-tests.o
...
.PHONY: tea-add-ddt-search-tests
tea-add-ddt-search-tests: $(BIN_PATH)tea-add-ddt-search-tests

$(BIN_PATH)tea-add-ddt-search-tests: $(OBJ_PATH)common.o $(OBJ_PATH)tea.o $(OBJ_PATH)adp-tea-f-fk-ddt.o $(OBJ_PATH)tea-add-ddt-search.o $(OBJ_PATH)tea-add-ddt-search-tests.o
...
.PHONY: adp-tea-f-fk-ddt-tests
adp-tea-f-fk-ddt-tests: $(BIN_PATH)adp-tea-f-fk-ddt-tests

$(BIN_PATH)adp-tea-f-fk-ddt-tests: $(OBJ_PATH)common.o $(OBJ_PATH)tea.o $(OBJ_PATH)adp-tea-f-fk-ddt.o $(OBJ_PATH)adp-tea-f-fk-ddt-tests.o
...
.PHONY: adp-tea-f-fk-noshift-tests
adp-tea-f-fk-noshift-tests: $(BIN_PATH)adp-tea-f-fk-noshift-tests

$(BIN_PATH)adp-tea-f-fk-noshift-tests: $(OBJ_PATH)common.o $(OBJ_PATH)tea.o $(OBJ_PATH)adp-tea-f-fk-noshift.o $(OBJ_PATH)adp-tea-f-fk-noshift-tests.o
...
.PHONY: adp-tea-f-fk-tests
adp-tea-f-fk-tests: $(BIN_PATH)adp-tea-f-fk-tests

$(BIN_PATH)adp-tea-f-fk-tests: $(OBJ_PATH)common.o $(OBJ_PATH)tea.o $(OBJ_PATH)adp-tea-f-fk.o $(OBJ_PATH)adp-tea-f-fk-tests.o
...
.PHONY: eadp-tea-f
eadp-tea-f: $(BIN_PATH)eadp-tea-f

$(BIN_PATH)eadp-tea-f: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-set.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)tea.o $(OBJ_PATH)eadp-tea-f.o $(OBJ_PATH)eadp-tea-f-program.o
	$(CC) $(LFLAGS) $(EADP_TEA_F_OBJ) -o $(BIN_PATH)eadp-tea-f $(LIBS)

.PHONY: max-eadp-tea-f
max-eadp-tea-f: $(BIN_PATH)max-eadp-tea-f

$(BIN_PATH)max-eadp-tea-f: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-set.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)tea.o $(OBJ_PATH)eadp-tea-f.o $(OBJ_PATH)max-eadp-tea-f-program.o
...
.PHONY: max-xdp-add
max-xdp-add: $(BIN_PATH)max-xdp-add

$(BIN_PATH)max-xdp-add: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)max-xdp-add-program.o
	$(CC) $(LFLAGS) $(MAX_XDP_ADD_OBJ) -o $(BIN_PATH)max-xdp-add $(LIBS)

.PHONY: max-xdp-add-tests
max-xdp-add-tests: $(BIN_PATH)max-xdp-add-tests

$(BIN_PATH)max-xdp-add-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)max-xdp-add-tests.o
...
.PHONY: xdp-add
xdp-add: $(BIN_PATH)xdp-add

$(BIN_PATH)xdp-add: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)xdp-add-program.o
	$(CC) $(LFLAGS) $(XDP_ADD_OBJ) -o $(BIN_PATH)xdp-add $(LIBS)

.PHONY: xdp-add-tests
xdp-add-tests: $(BIN_PATH)xdp-add-tests

$(BIN_PATH)xdp-add-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)xdp-add-tests.o
...
.PHONY: xlp-add
xlp-add: $(BIN_PATH)xlp-add

$(BIN_PATH)xlp-add: $(OBJ_PATH)common.o $(OBJ_PATH)xlp-add.o $(OBJ_PATH)xlp-add-program.o
	$(CC) $(LFLAGS) $(XLP_ADD_OBJ) -o $(BIN_PATH)xlp-add $(LIBS)

.PHONY: xlp-add-tests
xlp-add-tests: $(BIN_PATH)xlp-add-tests

$(BIN_PATH)xlp-add-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)xlp-add.o $(OBJ_PATH)xlp-add-tests.o
...
.PHONY: max-adp-xor-fi
max-adp-xor-fi: $(BIN_PATH)max-adp-xor-fi

$(BIN_PATH)max-adp-xor-fi: $(OBJ_PATH)adp-xor.o $(OBJ_PATH)max-adp-xor.o $(OBJ_PATH)adp-xor-fi.o $(OBJ_PATH)max-adp-xor-fi.o $(OBJ_PATH)max-adp-xor-fi-program.o
	$(CC) $(LFLAGS) $(MAX_ADP_XOR_FI_OBJ) -o $(BIN_PATH)max-adp-xor-fi $(LIBS)

.PHONY: max-adp-xor-fi-tests
max-adp-xor-fi-tests: $(BIN_PATH)max-adp-xor-fi-tests
...
.PHONY: adp-xor-fi
adp-xor-fi: $(BIN_PATH)adp-xor-fi

$(BIN_PATH)adp-xor-fi: $(OBJ_PATH)adp-xor-fi.o $(OBJ_PATH)adp-xor-fi-program.o
	$(CC) $(LFLAGS) $(ADP_XOR_FI_OBJ) -o $(BIN_PATH)adp-xor-fi $(LIBS)

.PHONY: adp-xor-fi-tests
adp-xor-fi-tests: $(BIN_PATH)adp-xor-fi-tests

$(BIN_PATH)adp-xor-fi-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor-fi.o $(OBJ_PATH)adp-xor-fi-tests.o
...
.PHONY: adp-xor-fi-count-odiff-tests
adp-xor-fi-count-odiff-tests: $(BIN_PATH)adp-xor-fi-count-odiff-tests

$(BIN_PATH)adp-xor-fi-count-odiff-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor-fi.o $(OBJ_PATH)adp-xor-fi-count-odiff.o $(OBJ_PATH)adp-xor-fi-count-odiff-tests.o
...
.PHONY: max-adp-xor3-set-tests
max-adp-xor3-set-tests: $(BIN_PATH)max-adp-xor3-set-tests

$(BIN_PATH)max-adp-xor3-set-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-set.o $(OBJ_PATH)max-adp-xor3-set-tests.o
...
.PHONY: max-adp-xor3
max-adp-xor3: $(BIN_PATH)max-adp-xor3

$(BIN_PATH)max-adp-xor3: $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-program.o
...
.PHONY: max-adp-xor3-tests
max-adp-xor3-tests: $(BIN_PATH)max-adp-xor3-tests

$(BIN_PATH)max-adp-xor3-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)max-adp-xor3.o $(OBJ_PATH)max-adp-xor3-tests.o
...
.PHONY: adp-xor3
adp-xor3: $(BIN_PATH)adp-xor3

$(BIN_PATH)adp-xor3: $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)adp-xor3-program.o
	$(CC) $(LFLAGS) $(ADP_XOR3_OBJ) -o $(BIN_PATH)adp-xor3 $(LIBS)

.PHONY: adp-xor3-tests
adp-xor3-tests: $(BIN_PATH)adp-xor3-tests

$(BIN_PATH)adp-xor3-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor3.o $(OBJ_PATH)adp-xor3-tests.o
...
.PHONY: max-adp-xor
max-adp-xor: $(BIN_PATH)max-adp-xor

$(BIN_PATH)max-adp-xor: $(OBJ_PATH)adp-xor.o $(OBJ_PATH)max-adp-xor.o $(OBJ_PATH)max-adp-xor-program.o
	$(CC) $(LFLAGS) $(MAX_ADP_XOR_OBJ) -o $(BIN_PATH)max-adp-xor $(LIBS)

.PHONY: max-adp-xor-tests
max-adp-xor-tests: $(BIN_PATH)max-adp-xor-tests

$(BIN_PATH)max-adp-xor-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)max-adp-xor.o $(OBJ_PATH)max-adp-xor-tests.o
...
.PHONY: adp-rsh-xor-tests
adp-rsh-xor-tests: $(BIN_PATH)adp-rsh-xor-tests

$(BIN_PATH)adp-rsh-xor-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)adp-rsh-xor.o $(OBJ_PATH)adp-rsh-xor-tests.o
...
.PHONY: adp-lsh
adp-lsh: $(BIN_PATH)adp-lsh

$(BIN_PATH)adp-lsh: $(OBJ_PATH)common.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)adp-lsh-program.o
	$(CC) $(LFLAGS) $(ADP_LSH_OBJ) -o $(BIN_PATH)adp-lsh $(LIBS)

.PHONY: adp-rsh
adp-rsh: $(BIN_PATH)adp-rsh

$(BIN_PATH)adp-rsh: $(OBJ_PATH)common.o $(OBJ_PATH)adp-shift.o $(OBJ_PATH)adp-rsh-program.o
	$(CC) $(LFLAGS) $(ADP_RSH_OBJ) -o $(BIN_PATH)adp-rsh $(LIBS)

.PHONY: adp-shift-tests
adp-shift-tests: $(BIN_PATH)adp-shift-tests
...
.PHONY: xdp-add-pddt-tests
xdp-add-pddt-tests: $(BIN_PATH)xdp-add-pddt-tests

$(BIN_PATH)xdp-add-pddt-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)xdp-add-pddt.o $(OBJ_PATH)xdp-add-pddt-tests.o
...
.PHONY: adp-xor-pddt-tests
adp-xor-pddt-tests: $(BIN_PATH)adp-xor-pddt-tests

$(BIN_PATH)adp-xor-pddt-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-xor-pddt.o $(OBJ_PATH)adp-xor-pddt-tests.o
...
.PHONY: adp-arx-tests
adp-arx-tests: $(BIN_PATH)adp-arx-tests

$(BIN_PATH)adp-arx-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-arx.o $(OBJ_PATH)max-adp-arx.o $(OBJ_PATH)adp-arx-tests.o
...
.PHONY: adp-xor
adp-xor: $(BIN_PATH)adp-xor

$(BIN_PATH)adp-xor: $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-xor-program.o
	$(CC) $(LFLAGS) $(ADP_XOR_OBJ) -o $(BIN_PATH)adp-xor $(LIBS)

.PHONY: adp-xor-tests
adp-xor-tests: $(BIN_PATH)adp-xor-tests

$(BIN_PATH)adp-xor-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-xor-tests.o
...
.PHONY: adp-xor-count-odiff-tests
adp-xor-count-odiff-tests: $(BIN_PATH)adp-xor-count-odiff-tests

$(BIN_PATH)adp-xor-count-odiff-tests: $(OBJ_PATH)common.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)adp-xor-count-odiff.o $(OBJ_PATH)adp-xor-count-odiff-tests.o
	$(CC) $(LFLAGS) $(ADP_XOR_COUNT_ODIFF_TESTS_OBJ) -o $(BIN_PATH)adp-xor-count-odiff-tests $(LIBS)

$(OBJ_PATH)adp-xor-count-odiff-tests.o: 
	$(CC) $(CFLAGS) -I$(INCLUDES) $(TESTS_PATH)adp-xor-count-odiff-tests.cc -o $(OBJ_PATH)adp-xor-count-odiff-tests.o

$(OBJ_PATH)adp-xor-count-odiff.o: 
...
.PHONY: graphviz-tests
graphviz-tests: $(BIN_PATH)graphviz-tests

$(BIN_PATH)graphviz-tests: $(OBJ_PATH)common.o $(OBJ_PATH)graphviz-tests.o
	$(CC) $(LFLAGS) $(GRAPHVIZ_TESTS_OBJ) -o $(BIN_PATH)graphviz-tests $(LIBS)

$(OBJ_PATH)graphviz-tests.o: 
...
.PHONY: morus-tests
morus-tests: $(BIN_PATH)morus-tests

$(BIN_PATH)morus-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-and.o $(OBJ_PATH)adp-xor.o $(OBJ_PATH)morus-tests.o
...
.PHONY: linear-code-tests
linear-code-tests: $(BIN_PATH)linear-code-tests

$(BIN_PATH)linear-code-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-add.o $(OBJ_PATH)max-xdp-add.o $(OBJ_PATH)linear-code-tests.o
...
.PHONY: norx-tests
norx-tests: $(BIN_PATH)norx-tests

$(BIN_PATH)norx-tests: $(OBJ_PATH)common.o $(OBJ_PATH)xdp-and.o $(OBJ_PATH)norx-tests.o
